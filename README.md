...
Wonder How we can Faq Boxes card using HTML CSS JS and by customising font-awesome icons directle in css? If No, this will be the perfect repo for you.

###### **Here is the link of [Live Demo](https://smilegupta.github.io/faq-boxes/)**
